...
/* the public class with all declared variables */
public class CodeA4MK extends JPanel implements KeyListener, MouseListener {
    ...
    private static String windSound = "wind2"; // Name of the wind sound file
    ...
    public static TransformGroup create_Base(String str) {
        ...
        scaler.setScale(new Vector3d(4d, 2d, 4d)); // scale for 4x4 matrix
    ...
    private static TransformGroup create_Fan() {
        ...
        fanTG.addChild(create_Base("MK's Desk Fan")); // attaching base to the fan stand
        return fanTG;
    }
    ...
    public CodeA4MK(BranchGroup sceneBG, TransformGroup sceneTG) {
    ...
    public static void main(String[] args) {
        ...
        frame.getContentPane().add(new CodeA4MK(sceneBG, sceneTG));
