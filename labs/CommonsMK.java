...
public class CommonsMK extends JPanel {
	...
	public CommonsMK(BranchGroup sceneBG) {
	...
	public static void main(String[] args) {
		frame = new JFrame("MK's Common File");            // NOTE: change XY to student's initials
		frame.getContentPane().add(new CommonsMK(create_Scene()));  // create an instance of the class
